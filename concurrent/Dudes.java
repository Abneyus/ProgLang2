...
public class Dudes extends UniversalActor  {
	public static void main(String args[]) {
		...
		Dudes instance = (Dudes)new Dudes(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Dudes(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Dudes.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Dudes(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Dudes.getReferenceByLocation(new UAL(ual)); }
	public Dudes(boolean o, UAN __uan)	{ super(false,__uan); }
	public Dudes(boolean o, UAL __ual)	{ super(false,__ual); }
	public Dudes(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Dudes(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Dudes(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Dudes()		{  }
	public Dudes(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "concurrent.Dudes", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Dudes)actorReference).setUAL(getUAL());
			((Dudes)actorReference).setUAN(getUAN());
			self = new Dudes(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "concurrent.Dudes$State" );
